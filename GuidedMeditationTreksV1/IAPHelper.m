...
static NSString *INAPP_RELATIONSHIP = @"com.russellEricDobda.inAppPurchase.relationshipHealing";
static NSString *INAPP_THOUGHTS = @"com.russellEricDobda.inAppPurchase.reprogramThoughts";
static NSString *INAPP_MANIFEST = @"com.russellEricDobda.inAppPurchase.manifestation";
...
+ (NSString *) inAppNameManifest { return INAPP_MANIFEST; }
+ (NSString *) inAppNameThoughts { return INAPP_THOUGHTS; }
+ (NSString *) inAppNameRelationship { return INAPP_RELATIONSHIP; }
...
+ (NSMutableArray*) getAudioFilenames:(NSString*)trackId
{
    ...
    if([trackId isEqualToString:@"01"])
    {
        ...
        [audioFilenames addObject:[[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"%@%@", trackId, @"pinknoise"] ofType:@"m4a"]];
    ...
    else
    {
        ...
        [audioFilenames addObject:[downloadPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@%@", trackId, @"pinknoise.m4a"]]];
...
+ (bool) inAppPurchaseDownloaded:(NSString * ) iapName
{
    ...
    if ([iapName isEqualToString:INAPP_RELATIONSHIP])
    {
        trackId = @"02";
    }
    else if ([iapName isEqualToString:INAPP_THOUGHTS])
    {
        trackId = @"03";
    }
    else if ([iapName isEqualToString:INAPP_MANIFEST])
    {
        trackId = @"04";
    }
